...
from analyst.legend import CANONICAL_GAPS, RISK_CLASS
from analyst.models import AnswerHistory, DetectHint, Exposure, GapRow, StateGrid
...
GAP_SIGNALS: dict[str, tuple[str, ...]] = {
    ...
    "GA": ("assume", "believe", "probably", "likely", "think that"),
    "GB": ("runtime", "operates live", "production", "moderation queue"),
    "GC": ("human review", "intervene", "manual review", "support team"),
    "GD": (
