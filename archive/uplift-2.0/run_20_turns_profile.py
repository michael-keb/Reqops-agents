...
When MCQs are present, state your choice (A/B/C/D) per question and one sentence why.
Write plain user message text — no markdown headers, no "As an AI".
...
Write your next user message (2–8 sentences). Cover every numbered MCQ if present.
"""
