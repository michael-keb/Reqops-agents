"""Canonical discovery state codes (v0.2)."""
...
OPEN_EXPOSURES: frozenset[str] = frozenset({"X1", "X2", "X4", "X6", "X7", "X8"})
...
READINESS: frozenset[str] = frozenset({"R1", "R2", "R3", "R4", "R5"})

SHAPING: frozenset[str] = frozenset({"S1", "S2", "S3", "S4", "S5"})

BATCH: frozenset[str] = frozenset({"Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7"})

COACHING: frozenset[str] = frozenset({"C1", "C2", "C3", "C4", "C5"})
